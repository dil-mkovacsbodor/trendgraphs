  ...
  return (
    <SelectPrimitive.Trigger
      ...
      className={cn(
        ...
        "dark:border-input/50 dark:text-foreground/90",
        className
      )}
      {...props}
    >
    ...
    <SelectPrimitive.Portal>
      <SelectPrimitive.Content
        ...
        className={cn(
          ...
          "dark:bg-popover/90 dark:border-border/50",
          position === "popper" &&
...
function SelectLabel({
  ...
  return (
    <SelectPrimitive.Label
      ...
      className={cn("text-muted-foreground px-2 py-1.5 text-xs dark:text-muted-foreground/80", className)}
      {...props}
    />
  )
}
  ...
  return (
    <SelectPrimitive.Item
      ...
      className={cn(
        ...
        "dark:hover:bg-accent/50 dark:text-foreground/90",
        className
      )}
      {...props}
    >
...
function SelectSeparator({
  ...
  return (
    <SelectPrimitive.Separator
      ...
      className={cn("bg-border pointer-events-none -mx-1 my-1 h-px dark:bg-border/50", className)}
      {...props}
    />
  )
}
